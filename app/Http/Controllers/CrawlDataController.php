...
class CrawlDataController extends Controller
{
    ...
    function test()
    {
        $episodeLink = 'https://wibu47.com/xem-phim/one-piece-dao-hai-tac/1095';
    ...
    function index()
    {
        $url = 'https://wibu47.com/the-loai/tien-hiep';
